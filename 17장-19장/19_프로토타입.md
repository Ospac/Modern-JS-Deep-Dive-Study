...
- 모든 객체는 `[[Prototype]]`이라는 내부 슬롯을 가지며, 이 내부 슬롯의 값은 프로토타입의 참조다.
    ...
    <img width="1922" height="730" alt="image" src="https://github.com/user-attachments/assets/00e0c3b6-a762-48b4-a452-51b1ab64c490" />

### 19.3.1 __proto__ 접근자 프로퍼티
객체는 `__proto__` 프로퍼티를 통해 자신의 프로토타입 즉 `[[Prototype]]` 내부 슬롯에 간접적으로 접근한다.

<img width="640" height="362" alt="download (7)" src="https://github.com/user-attachments/assets/51e18f49-409a-4a70-a71b-d085a2ee91b8" />
